...
class DataModule {
    ...
    @Provides
    @Singleton
    internal fun provideAuthRepository(keyValueStorage: KeyValueStorage, authService: AuthService, config: Config): AuthRepository =
        DefaultAuthRepository(keyValueStorage, authService, config)
